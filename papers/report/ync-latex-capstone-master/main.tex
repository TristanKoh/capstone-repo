...
\thesistitle{Applying Explainable AI Techniques on the APP-350 Corpus} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
