...
I owe a debt of gratitude to Prof. Chesterman \& Prof. Choi, who have willingly taken on this strange mixture of MCS and law and offered invaluable feedback and encouragement, and to Prof. Danvy \& Prof. Francesca, because without their reassurance and nurture, I would never have dreamt of majoring in MCS.

I am privileged to have shared fond memories and laughter with Rayner, Nat, Ziying, and Glen, and to have had the companionship of the DDP Class of 2022+1, who have made this five-year sojourn all the more transformative. Special mention must go to the thankless toil of the cleaning and catering aunties and uncles, without whom this whole residential experience would not have lasted more than 12 hours.

Finally, I would like to thank my survey respondents, because without their participation, I would only have half a capstone.
...
Natural language processing (NLP) techniques have recently increased in performance and can potentially automate some areas of substantive legal reasoning and writing, but has come at the cost of increased opacity of the models. Applying eXplainable AI (XAI) has been introduced to combat this opacity, but it is unclear whether such explanations are effective for the different purposes and users of the explanations. The stakeholders in data privacy regulation (i.e. organisations, data privacy regulatory authorities, and consumers of data services) can also benefit from the use of XAI. Therefore, there is a gap in research that assesses the effectiveness of XAI, and XAI's particular application in data privacy.

This capstone uses this data privacy context to train and evaluate AI classifiers that are able to detect data practices within PlayStore apps' data privacy policies. XAI techniques are applied on these models to produce visualisations that aim to explain these predictions to these stakeholders in data privacy. Finally, the effectiveness of these visualisations are assessed by surveying the general public along differing metrics of explainability.

Word count: 11,226 (original = 9712 (incl footnotes), +50 for citations, and x1.15 for tables, content page, abstract, and acknowledgements.)
\end{abstract}
